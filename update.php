...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {
        ...
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', date_of_birth = '$date_of_birth', picture = '$pictureArray->fileName', phonenumber = '$phonenumber', adress = '$adress' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', date_of_birth = '$date_of_birth', phonenumber = '$phonenumber', adress = '$adress' WHERE id = {$id}";
    }
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>Phonenumber</th>
                    <td><input class="form-control" type="text" name="phonenumber" placeholder="Phonenumber" value="<?php echo $phonenumber ?>" /></td>
                </tr>
                <tr>
                    <th>Address</th>
                    <td><input class="form-control" type="text" name="adress" placeholder="Addresse" value="<?php echo $adress ?>" /></td>
                </tr>
                <tr>
